          ...
          groups: [
            {
              ...
              items: [
                ...
                { label: { es: "Chilaquiles Verdes",            en: "Green Chilaquiles"           }, tags: ["picante"],   description: { es: "Bañados con salsa verde preparados con crema y queso.", en: "Bathed in green sauce with cream and cheese." } },
                { label: { es: "Huevos con Jamón",              en: "Ham & Eggs"                 }, tags: [],            description: { es: "Esponjoso huevo revuelto con jamón y un toque de mantequilla.", en: "Fluffy scrambled egg with ham and butter." } },
                { label: { es: "Rollitos de Pollo y Vegetales", en: "Chicken & Vegetable Rolls"  }, tags: [],            description: { es: "Pechuga de pollo rellena de calabaza, zanahoria y pimientos con salsa de tomate y orégano.", en: "Chicken stuffed with squash, carrot and peppers with tomato sauce and oregano." } },
          ...
          groups: [
            {
              ...
              isHotKitchen: true,
              items: [
                { label: { es: "Waffles",                en: "Waffles"              }, tags: ["vegetarian"],          description: { es: "De sabor suave y ligero espolvoreados con azúcar glass.", en: "Light and fluffy, dusted with powdered sugar." } },
                ...
                { label: { es: "Huevos con Jamón",       en: "Ham & Eggs"           }, tags: [],                     description: { es: "Esponjoso huevo revuelto con jamón y un toque de mantequilla.", en: "Fluffy scrambled egg with ham and butter." } },
                { label: { es: "Queso Panela Asado",     en: "Grilled Panela Cheese"}, tags: ["vegetarian"],          description: { es: "Rebanadas de queso panela asadas servidas con salsa de tomate y orégano.", en: "Grilled panela cheese slices with tomato sauce and oregano." } },
                { label: { es: "Muffin de Huevo y Tocino", en: "Egg & Bacon Muffin"}, tags: [],                     description: { es: "Huevo con tocino crujiente, servido con salsa de tomate y orégano.", en: "Egg with crispy bacon, tomato sauce and oregano." } },
